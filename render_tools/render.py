...
def render_one_image(model_id, camera_idx, render_idx, height, width, use_raytracing=False, replace_texture=False):
    ...
    anno_data_path = pjoin(DATASET_PATH, category, str(model_id))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_id', type=int, default=290, help='Specify the model id to render')
    ...
    assert not args.replace_texture, "Replace texture is not needed for AKB-48 dataset"
